...
void keyPressed () {
  ...
  if (game_1.state == "init") {
  ...
  else if ( (game_1.state == "play") && (game_1.Letters.get(0).letter_in_circle()) && (game_1.Letters.get(1).letter_in_circle()) ){
    if( (key == Character.toLowerCase(game_1.Letters.get(0).command)) && (game_1.Letters.get(0).letter_in_circle())){
    ...
    if( (key == Character.toLowerCase(game_1.Letters.get(1).command)) && (game_1.Letters.get(1).letter_in_circle()) ){
  

      game_1.c.cont = true;
      if(game_1.Letters.get(1).command == 'A'){
  
        noStroke();
        fill(0,250,0);
        ellipse(50,700,78,78);
        game_1.Letters.remove(1);
        
        stroke(0,250,0);
        textAlign(CENTER,CENTER);
        text("Awesome!",170,200);
      }
      else if(game_1.Letters.get(1).command == 'W'){
        noStroke();
        fill(0,250,0);
        ellipse(130,700,78,78);
        game_1.Letters.remove(1);
      ...
      else if(game_1.Letters.get(1).command == 'S'){
        noStroke();
        fill(0,250,0);
        ellipse(210,700,78,78);
        game_1.Letters.remove(1);
      ...
      else if(game_1.Letters.get(1).command == 'D'){
        noStroke();
        fill(0,250,0);
        ellipse(290,700,78,78);
        game_1.Letters.remove(1);
  ...
  else if ((game_1.state == "fail") && (key == 'q')) {
    game_1.state = "quit";
  }
}